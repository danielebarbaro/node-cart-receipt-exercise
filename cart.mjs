...
for(let item of carts){
    ...
    // inizio
        ...
        if (disponibilitaUtente>0){
            ...
            receipt +='Credito Utente:'+ disponibilitaUtente +'\n'

        }
        else{
            receipt +=nomeUtente + 'ha il portafoglio vuoto.\n'
        }
    ...
    receipt +=core.divisorio('*',55)+'\n';
        receipt += '\tTotale Odine:\t\t' +  totOrdine.toFixed(2) + '\n'
    receipt += core.divisorio('+',55) + '\n';
    if(promoUtente !== '' && promoUtente !== undefined && promoUtente !== null){
            receipt +=`\tCodice Promo:\t ${promoUtente}\n`
            receipt +=`\tSconto:\t ${rate}\n`
        ...
        if(creditoResiduo>=0)
            ...
            receipt +='Credito non sufficiente' + '\n'
        receipt += core.divisorio('**',55,)+'\n\n'
